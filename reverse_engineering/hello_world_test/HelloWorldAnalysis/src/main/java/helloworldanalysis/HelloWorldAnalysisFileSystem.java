...
@FileSystemInfo(type = "fstypegoeshere", // ([a-z0-9]+ only)
		description = "File system description goes here", factory = HelloWorldAnalysisFileSystem.MyFileSystemFactory.class)
public class HelloWorldAnalysisFileSystem implements GFileSystem {
	 ...
	 */
	public HelloWorldAnalysisFileSystem(FSRLRoot fsFSRL, ByteProvider provider) {
		this.fsFSRL = fsFSRL;
	...
	public void mount(TaskMonitor monitor) {
		monitor.setMessage("Opening " + HelloWorldAnalysisFileSystem.class.getSimpleName() + "...");
	...
	public static class MyFileSystemFactory
			implements GFileSystemFactoryByteProvider<HelloWorldAnalysisFileSystem>,
			GFileSystemProbeByteProvider {

		@Override
		public HelloWorldAnalysisFileSystem create(FSRLRoot targetFSRL,
				ByteProvider byteProvider, FileSystemService fsService, TaskMonitor monitor)
				throws IOException, CancelledException {

			HelloWorldAnalysisFileSystem fs = new HelloWorldAnalysisFileSystem(targetFSRL, byteProvider);
			fs.mount(monitor);
			return fs;
		}
