...
//@formatter:on
public class HelloWorldAnalysisPlugin extends ProgramPlugin {
	 ...
	 */
	public HelloWorldAnalysisPlugin(PluginTool tool) {
		super(tool);
	...
	private static class MyProvider extends ComponentProvider {
		...
		public MyProvider(Plugin plugin, String owner) {
			super(plugin.getTool(), "HelloWorldAnalysis Provider", owner);
			buildPanel();
			createActions();
		}
